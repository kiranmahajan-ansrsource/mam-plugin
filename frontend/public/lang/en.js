export default {
  ...
  "components.filter.additionalContentTooltip":
    "Use <b>left/right arrow keys</b> to move focus inside this list item",
  ...
  "components.filter.clearAllAnnounceOverride":
    "Clearing all filters for: {filterText}",
  ...
  "components.filter.selectedFirstListLabel":
    "{headerText}. Selected filters appear first.",
  ...
  "components.filter-dimension-set-date-text-value.textMonths":
    "Last {num} months",
  "components.filter-dimension-set-date-time-range-value.label":
    "{text}, expand to choose dates",
  "components.filter-dimension-set-date-time-range-value.text":
    "Custom date range",
  "components.filter-dimension-set-date-time-range-value.valueTextRange":
  ...
  "components.input-date-time-range.errorBadInput":
    "{startLabel} must be before {endLabel}",
  "components.input-date-time-range.interactive-label":
    "Date and time range input",
  "components.input-date-time-range.startDate": "Start Date",
  "components.input-date-time-range-to.to": "to",
  "components.input-number.hintDecimalDuplicate":
    "There’s already a decimal in this number",
  "components.input-number.hintDecimalIncorrectComma":
    "To add a decimal use the comma “,” character",
  "components.input-number.hintDecimalIncorrectPeriod":
    "To add a decimal use the period “.” character",
  "components.input-number.hintInteger":
    "This field only accepts integer values (no decimals)",
  ...
  "components.interactive.instructions":
    "Press Enter to interact, Escape to exit",
  "components.link.open-in-new-window": "Opens in a new window.",
  "components.list.keyboard":
    "Use <b>arrow keys</b> to move focus inside this list, or <b>page up/down</b> to move up or down by 5",
  ...
  "components.list-item-drag-handle.keyboard":
    "Reorder item, current position {currentPosition} out of {size}. To move this item, press up or down arrows.",
  ...
  "components.menu-item-return.returnCurrentlyShowing":
    "Return to previous menu. You are viewing {menuTitle}.",
  ...
  "components.selection.action-required-hint":
    "Select an item to perform this action",
  ...
  "components.table-col-sort-button.changeSortOrder":
    "Select to change sort order",
  ...
  "components.tag-list.clear":
    "Click, press backspace, or press delete key to remove item {value}",
  ...
  "components.tag-list.show-more-description":
    "Select to show hidden tag list items",
